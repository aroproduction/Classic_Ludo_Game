...
try:
    ...
    print(e)
logo = PhotoImage(file="Resources/whitebox.gif")  # Loading all the image files that are required in the game.
logo2 = PhotoImage(file="Resources/red side.gif")  # Loading all the image files that are required in the game.
logo3 = PhotoImage(file="Resources/red.gif")  # Loading all the image files that are required in the game.
logo4 = PhotoImage(file="Resources/blue side.gif")
logo5 = PhotoImage(file="Resources/green side.gif")
logo6 = PhotoImage(file="Resources/yellow side.gif")
logo7 = PhotoImage(file="Resources/center.gif")
logoxx = PhotoImage(file="Resources/test.gif")
logog = PhotoImage(file="Resources/greenbox.gif")
logogs = PhotoImage(file="Resources/greenstop.gif")
logoy = PhotoImage(file="Resources/yellowbox.gif")
logoys = PhotoImage(file="Resources/yellowstop.gif")
logob = PhotoImage(file="Resources/bluebox.gif")
logobs = PhotoImage(file="Resources/bluestop.gif")
logor = PhotoImage(file="Resources/redbox.gif")
logors = PhotoImage(file="Resources/redstop.gif")
logoh = PhotoImage(file="Resources/head.gif")
logot = PhotoImage(file="Resources/tail.gif")
logoh1 = PhotoImage(file="Resources/head1.gif")
logot1 = PhotoImage(file="Resources/tail1.gif")
logoh2 = PhotoImage(file="Resources/head2.gif")
logot2 = PhotoImage(file="Resources/tail2.gif")
logoh3 = PhotoImage(file="Resources/head3.gif")
logot3 = PhotoImage(file="Resources/tail3.gif")
logoab = PhotoImage(file="Resources/blue.gif")
logoay = PhotoImage(file="Resources/yellow.gif")
logoag = PhotoImage(file="Resources/green.gif")
...
def board():  # Drawing the board, piece by piece.
    ...
    # Splash Screen.
    tkinter.messagebox.showinfo(title=None, message="TO START GAME PRESS OK! @iamARITRA")
    v = 0
    z = 0
